...
const projectsList = [
  ...
  },
  {
    ...
    description: "Проект представляет собой сайт на котором представлена основная информация об обучении, а также сервис movies-explorer с поиском и сохранением фильмов.",
    techs: [
      {
        index: 1,
        name: "React"
